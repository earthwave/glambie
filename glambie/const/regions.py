...
REGIONS = {
    ...
    'north_asia': RGIRegion(rgi_id=10, name='north_asia', long_name='North Asia',
                            ...
                            glaciological_year_start=0.75),
    'central_europe': RGIRegion(rgi_id=11, name='central_europe', long_name='Central Europe',
                                rgi5_area=2075, rgi6_area=2092, rgi7_area=2092,
                                area_uncertainty_percentage=0.05,
                                area_change=-0.93,
                                area_change_reference_year=2003,
                                glaciological_year_start=0.75),
    'caucasus_middle_east': RGIRegion(rgi_id=12, name='caucasus_middle_east', long_name='Caucasus & Middle East',
                                      rgi5_area=1295, rgi6_area=1307, rgi7_area=1307,
                                      area_uncertainty_percentage=0.05,
                                      area_change=-0.53,
                                      area_change_reference_year=2001,
                                      glaciological_year_start=0.75),
    'central_asia': RGIRegion(rgi_id=13, name='central_asia', long_name='Central Asia',
                              ...
                              area_change_reference_year=2003,
                              glaciological_year_start=0.75),
    'south_asia_west': RGIRegion(rgi_id=14, name='south_asia_west', long_name='South Asia West',
                                 rgi5_area=33568, rgi6_area=33568, rgi7_area=33568,
                                 area_uncertainty_percentage=0.05,
                                 area_change=-0.36,
                                 area_change_reference_year=2003,
                                 glaciological_year_start=0.75),
    'south_asia_east': RGIRegion(rgi_id=15, name='south_asia_east', long_name='South Asia East',
                                 ...
                                 area_change_reference_year=2003,
                                 glaciological_year_start=0.75),
    'low_latitudes': RGIRegion(rgi_id=16, name='low_latitudes', long_name='Low Latitudes',
                               rgi5_area=2346, rgi6_area=2341, rgi7_area=2341,
                               area_uncertainty_percentage=0.05,
                               area_change=-1.19,
                               area_change_reference_year=2000,
                               glaciological_year_start=0.0),
    'southern_andes': RGIRegion(rgi_id=17, name='southern_andes', long_name='Southern Andes',
                                rgi5_area=29333, rgi6_area=29429, rgi7_area=29429,
                                area_uncertainty_percentage=0.05,
                                area_change=-0.18,
                                area_change_reference_year=2000,
                                glaciological_year_start=0.25),
    'new_zealand': RGIRegion(rgi_id=18, name='new_zealand', long_name='New Zealand',
                             rgi5_area=1162, rgi6_area=1162, rgi7_area=1162,
                             area_uncertainty_percentage=0.05,
                             area_change=-0.69,
                             area_change_reference_year=1978,
                             glaciological_year_start=0.25),
    'antarctic_and_subantarctic': RGIRegion(rgi_id=19, name='antarctic_and_subantarctic',
                                            long_name='Antarctic and Subantarctic Islands',
                                            rgi5_area=132867, rgi6_area=132867, rgi7_area=132867,
                                            area_uncertainty_percentage=0.05,
                                            area_change=-0.27,
