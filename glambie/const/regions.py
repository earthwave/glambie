...
class RGIRegion:
    ...
    rgi6_area: float
    rgi7_area: float
    area_uncertainty_percentage: (
        float  # area uncertainty would be area_uncertainty_percentage * area
    )
...
REGIONS = {
    ...
    "western_canada_us": RGIRegion(
        rgi_id=2,
        name="western_canada_us",
        long_name="Western Canada & USA",
        short_name="WNA",
        rgi5_area=14556,
        rgi6_area=14524,
        rgi7_area=14521,
    ...
    "arctic_canada_north": RGIRegion(
        rgi_id=3,
        name="arctic_canada_north",
        long_name="Arctic Canada North",
        short_name="ACN",
        rgi5_area=105128,
        rgi6_area=105111,
        rgi7_area=105370,
    ...
    "arctic_canada_south": RGIRegion(
        rgi_id=4,
        name="arctic_canada_south",
        long_name="Arctic Canada South",
        short_name="ACS",
        rgi5_area=40888,
        rgi6_area=40888,
        rgi7_area=40538,
    ...
    "greenland_periphery": RGIRegion(
        rgi_id=5,
        name="greenland_periphery",
        long_name="Greenland Periphery",
        short_name="GRL",
        rgi5_area=89717,
        rgi6_area=89717,
        rgi7_area=90482,
    ...
    "caucasus_middle_east": RGIRegion(
        rgi_id=12,
        name="caucasus_middle_east",
        long_name="Caucasus & Middle East",
        short_name="CAU",
        rgi5_area=1295,
        rgi6_area=1307,
        rgi7_area=1407,
    ...
    "south_asia_west": RGIRegion(
        rgi_id=14,
        name="south_asia_west",
        long_name="South Asia West",
        short_name="ASW",
        rgi5_area=33568,
        rgi6_area=33568,
        rgi7_area=33075,
    ...
    "south_asia_east": RGIRegion(
        rgi_id=15,
        name="south_asia_east",
        long_name="South Asia East",
        short_name="ASE",
        rgi5_area=14734,
        rgi6_area=14734,
        rgi7_area=16049,
    ...
    "antarctic_and_subantarctic": RGIRegion(
        ...
        long_name="Antarctic & Subantarctic Islands",
        short_name="ANT",
        rgi5_area=132867,
        rgi6_area=132867,
        rgi7_area=133432,
